...
public class Slider : BaseControl
{
    ...
    public override void Refresh()
    {
		...
		float extent = Background.GetComponent<UnityEngine.UI.Image>().sprite.bounds.max.y - Background.GetComponent<UnityEngine.UI.Image>().sprite.bounds.min.y;
        MaxExtent = extent / 2f;

		Size = Background.GetComponent<UnityEngine.UI.Image> ().sprite.texture.height;

		Min = Background.GetComponent<UnityEngine.UI.Image> ().sprite.bounds.min.y;
		Max = Background.GetComponent<UnityEngine.UI.Image>().sprite.bounds.max.y;
